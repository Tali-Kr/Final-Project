...
link = "https://www.transfermarkt.com/ligat-haal/formtabelle/wettbewerb/ISR1?saison_id=2022&min=1&max="
for round in range(1, 27):
    all_the_link.append(link + str(round))
link = "https://www.transfermarkt.com/ligat-haal-meisterrunde/formtabelle/wettbewerb/ISRF?saison_id=2022&min=1&max="
for round in range(1, 8):
    all_the_link.append(link + str(round))
link = "https://www.transfermarkt.com/ligat-haal-abstiegsrunde/formtabelle/wettbewerb/ISRA?saison_id=2022&min=1&max="
