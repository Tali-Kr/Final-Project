...
ligat_haal = pd.read_csv(r'data_tables/ligat_haal.csv')
stadiums_in_israel = pd.read_csv(r'data_tables/Stadiums_In_Israel.csv')
club_home_stadium = pd.read_csv(r'data_tables/club_home_stadium.csv')
stadium_match = pd.read_csv(r'data_tables/stadium_match.csv')
ds = pd.read_csv('master_data.csv')
print(0)
