...
for year in range(fromYear, toYear+1):
    links.append('https://www.transfermarkt.com/ligat-haal/gesamtspielplan/wettbewerb/ISR1/saison_id/' + str(year))
    links.append('https://www.transfermarkt.com/ligat-haal-relegation-round/gesamtspielplan/wettbewerb/ISRA/saison_id/' +str(year))
    links.append('https://www.transfermarkt.com/ligat-haal-championship-round/gesamtspielplan/wettbewerb/ISRF/saison_id/' + str(year))
...
with open('../dataset_preparation/dt_prep_tables/ligat_haal_2012_21.csv', 'w', encoding='utf8', newline='') as f:
    theWriter = writer(f)
